...
class MainFragment : Fragment(), OnTaskClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainController.getTasks() //faz com que a lista seja atualizada
    }
    ...
    override fun onRemoveTaskMenuItemClick(position: Int) {
        mainController.removeTask(taskList[position])//solicitando ao maincontroller que remova a tarefa
    ...
    override fun onDoneCheckBoxClick(position: Int, checked: Boolean) {
        taskList[position].apply {
            ...
            mainController.editTask(this) //solicitando ao maincontroller que edite a tarefa
    ...
    fun updateTaskList(tasks: List<Task>) { //atualizando a lista de tarefas
